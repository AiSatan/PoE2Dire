...
function userscriptHeader() {
  return [
    ...
    "// @match       https://br.pathofexile.com/forum/*",
    "// @match       https://ru.pathofexile.com/forum/*",
    "// @match       https://th.pathofexile.com/forum/*",
    "// @match       https://de.pathofexile.com/forum/*",
    "// @match       https://fr.pathofexile.com/forum/*",
    "// @match       https://es.pathofexile.com/forum/*",
